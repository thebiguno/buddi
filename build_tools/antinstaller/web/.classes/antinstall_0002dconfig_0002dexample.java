...
public class antinstall_0002dconfig_0002dexample extends ObjectJspBase {
    ...
    // begin [file="/home/teknopaul/workspace/AntInstaller/web/home/teknopaul/workspace/AntInstaller/web/antinstall-config-example.jsp";from=(73,3);to=(193,0)]
        	...
        	for (int i = 0; i < file.length(); i++){
        		...
        		switch(c){
        			case '$' : {
        				if(file.charAt(i + 1) == '{'){
        					inRef = true;
        					sb.append("<a href=\"manual.html#refs\" title=\"\" class=\"reference\">$");
        				}
        				else {
        					sb.append(c);
        				}
        			...
        			case '<' : {
        				inElement = true;
        				elemStart = i;
        				sb.append("<span class=\"bracket\">&lt;</span>");
        				break;
        			}
        			case '>' : {
        				if(inElement){
        ...
        private String createLink(String element){
        	if(element.startsWith("/")) {
        		return "<span class=\"element\">" + element + "</span>";
        	}
    ...
    public void _jspService(final Destination destination)
        ...
        try {
            ...
            // end
            // HTML // begin [file="/home/teknopaul/workspace/AntInstaller/web/home/teknopaul/workspace/AntInstaller/web/antinstall-config-example.jsp";from=(72,2);to=(73,0)]
                out.write("\r\n");
            // end
            // HTML // begin [file="/home/teknopaul/workspace/AntInstaller/web/home/teknopaul/workspace/AntInstaller/web/antinstall-config-example.jsp";from=(193,2);to=(292,0)]
